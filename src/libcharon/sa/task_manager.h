 ...
 *
 * This is affected by modifications of retransmit_base, retransmit_timeout or
 * retransmit_tries. The resulting value can then be used e.g. in kernel
 * plugins to set the system's acquire timeout properly.
 *
